...
$sqlsat = "select 
  ...
  $tampilsat = mysqli_fetch_array($querysat);
...
$sql = "select * from imunisasi WHERE no_reg = ".$_GET['no_reg']." ";
$query = mysqli_query($con, $sql);
$nomer = 1;
if ($query) {
...
$sql = "select * from kb WHERE no_reg = ".$_GET['no_reg']." ";
$query = mysqli_query($con, $sql);
$nomer = 1;
if ($query) {
...
$sql = "select * from antenatal_care WHERE no_reg = ".$_GET['no_reg']." ";
$query = mysqli_query($con, $sql);
$nomer = 1;
if ($query) {
...
$html = $judul . $data_kunjungan . $data_bersalin . $data_imunisasi . $data_kb . $data_antenatal;
